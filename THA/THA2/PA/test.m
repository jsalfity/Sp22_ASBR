...
% % J_space.m
% Js = J_space(panda, q)
% Js_matlab = geometricJacobian(panda_matlab, q, 'panda_link7')
% 
% % J_body.m
% Jb = J_body(panda, q)
% Jb_matlab = geometricJacobian(panda_matlab, q, 'panda_link7')
% 
...
Tf = [1 0 0 0.088; 
      ...
      0 0 0 1];
q0 = [0 0 0 0 0 0 0]';
q = J_inverse_kinematics(panda, Ti, Tf, q0, 200)
