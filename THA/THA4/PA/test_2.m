...
%% PA 1a
% [q_final,orientation_1,tip_loc] = tool_tip_near_point(p_tip, p_goal, q_init, q_ub, q_lb, tol);
% 
% hold on
...
[q_final,tip_loc] = virtual_wall_b(p_tip, p_goal, q_init, q_ub, q_lb, tol,n_vec,wall_loc,d_wall,w_p,w_a);
